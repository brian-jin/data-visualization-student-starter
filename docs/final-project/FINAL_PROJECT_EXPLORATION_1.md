...
# Week 5: North Star Sketches
North Star sketches were generated by ChatGPT (GPT-5.6 Luna, free vers up to daily limit). I wanted to give a shot at using AI to generate the sketches. I did try to make a few edits by prompting what I wanted to change or see. Aside from the messy generated graphs (weird shadows in graphs like the skills network, wrong numbers or scribbles, etc.), I think the results look pretty good in terms of the high-level picture I'd like each idea to ideally represent. There are definitely changes I'd like to make when I actually create the visualization for one of the questions and potentially even out of scope ideas I won't be able to hit (the skills network or the neighborhood DNA). 
## Question 1: How is a changing/subtropical climate affecting different groups of New Yorkers?
